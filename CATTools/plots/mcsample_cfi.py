...
{"name":"TTWlNu", "selection": GW(), "file": files(loc + "ttWJetsToLNu"+z),  "cx":1.152,  "color": BCS[0],   "label":"t#bar{t}W          "    },
{"name":"TTWqq",  "selection": GW(), "file": files(loc + "ttWJetsToQQ"+z),   "cx":1.152,  "color": BCS[0],   "label":"t#bar{t}W          "    },
