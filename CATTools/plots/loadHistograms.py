...
def loadHistogramMC(mc, mon, Step, Weight,DYsf,f):
  HN = mon["name"]
  Weight1= Weight
  ...
  h1 = f.Get(name+"/"+Weight1+"/h1_"+name+"_"+HN+"_mm_"+Step+"_"+Weight1).Clone("h1_"+name+"_"+HN+"_"+Step+"mm"+"_"+Weight1)
  h2 = f.Get(name+"/"+Weight1+"/h1_"+name+"_"+HN+"_ee_"+Step+"_"+Weight1).Clone("h1_"+name+"_"+HN+"_"+Step+"ee"+"_"+Weight1)
  h3 = f.Get(name+"/"+Weight1+"/h1_"+name+"_"+HN+"_em_"+Step+"_"+Weight1).Clone("h1_"+name+"_"+HN+"_"+Step+"em"+"_"+Weight1)
...
def loadHistogramDATA(mon, Step, Weight,f2):
  HN = mon["name"]
  WeightData = Weight
  WeightData2 = Weight
  ...
  for i in range(1):
    ...
    h1 = f2.Get("MuMu1/"+WeightData+"/h1_MuMu1_"+HN+"_mm_"+Step+"_"+WeightData+"").Clone("h1_"+name_+"_"+HN+"_"+Step+"mm"+"_"+WeightData+"")
    h2 = f2.Get("ElEl1/"+WeightData+"/h1_ElEl1_"+HN+"_ee_"+Step+"_"+WeightData+"").Clone("h1_"+name_+"_"+HN+"_"+Step+"ee"+"_"+WeightData+"")
    h3 = f2.Get("MuEl1/"+WeightData+"/h1_MuEl1_"+HN+"_em_"+Step+"_"+WeightData+"").Clone("h1_"+name_+"_"+HN+"_"+Step+"em"+"_"+WeightData+"")
    h1.Reset()
    h2.Reset()
    h3.Reset()
    for j in range(1,3):
...
def mergesHistograms(selectedHists, oldHistograms,name):
  newHistograms = {}
  for hhh in oldHistograms.keys():
    if hhh in selectedHists:
      if len(newHistograms.keys())==0:
        ...
        newHistograms["hMM"]=oldHistograms[hhh]["hMM"].Clone( name+"_"+oldHistograms[hhh]["hMM"].GetName())
        newHistograms["hEE"]=oldHistograms[hhh]["hEE"].Clone( name+"_"+oldHistograms[hhh]["hEE"].GetName())
        newHistograms["hME"]=oldHistograms[hhh]["hME"].Clone( name+"_"+oldHistograms[hhh]["hME"].GetName())
      else:
