...
def files(path):
    ...
    if hostname.find("home")>-1 or hostname.find("cern.ch")>-1:
      llll = [""]
      return llll
...
{"name":"STtW",   "selection": GW(), "file": files(loc + "SingleTop_tW"+z),  "cx":35.6,   "color": BCS[0],   "label":"Single t"      },
{"name":"WW",     "selection": GW(), "file": files(loc + "WW"+z),            "cx":110.8,  "color": BCS[1],   "label":"VV            "    },
{"name":"WZ",     "selection": GW(), "file": files(loc + "WZ"+z),            "cx":66.1,   "color": BCS[1],   "label":"VV            "   },
{"name":"ZZ",     "selection": GW(), "file": files(loc + "ZZ"+z),            "cx":15.4,   "color": BCS[1],   "label":"VV            "   },
...
{"name":"ttH2bb",  "selection": GW(), "file": files(loc + "ttH_bb"+z),     "cx":0.5058,   "color": BCS[4],   "label":"t#bar{t}H         " ,"isStack":False   },
]
